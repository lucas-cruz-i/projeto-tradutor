  ...
  return (
    <div className='min-h-screen bg-background flex flex-col'>
      ...
      <main className='flex-grow flex items-start justify-center px-4 py-8'>
        <div className='w-full max-w-5xl bg-white rounded-lg shadow-md overflow-hidden'>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2'>
            ...
            <div className='p-4'>
              <textarea value={sourceText} onChange={event => setSourceText(event.target.value)} placeholder='Digite seu texto...' className='w-full h-40 text-lg text-textColor bg-transparent resize-none border-none outline-none font-semibold'>
              </textarea>
            </div>

            <div className='p-4 relative bg-secondaryBackground border-l border-gray-200 font-semibold'>
      ...
      <footer className='bg-white border-t border-gray-200 mt-auto'>
        <div className='max-w-5xl mx-auto px-4 py-3 text-sm text-headerColor font-bold'>
